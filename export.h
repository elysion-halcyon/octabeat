...
#define AS_SND_BEAM	(9)
#define AS_SND_DECIDE	(10)
#define AS_SND_KERSOL	(11)
#define AS_SND_01_OCTABEAT	(12)
#define AS_SND_02_WELCOME_TO_OCTABEAT	(13)
#define AS_SND_03_SELECT_THE_MUSIC	(14)
#define AS_SND_04_EASY	(15)
#define AS_SND_05_NORMAL	(16)
#define AS_SND_06_HARD	(17)
#define AS_SND_07_ARE_YOU_READY	(18)
#define AS_SND_08_GO	(19)
#define AS_SND_09_KEEP_THE_BEATS	(20)
#define AS_SND_10_WHAT_THE_FASCINATING_BEAT	(21)
#define AS_SND_11_FOLLOW_THE_RHYTHM	(22)
#define AS_SND_12_GET_INTO_THE_RHYTHM	(23)
#define AS_SND_13_MAKE_SOME_NOISE	(24)
#define AS_SND_14_TURN_IT_UP	(25)
#define AS_SND_15_TAKE_IT_EASY	(26)
#define AS_SND_16_NEVER_SAY_NEVER	(27)
#define AS_SND_17_PERFECT	(28)
#define AS_SND_18_GREAT	(29)
#define AS_SND_19_GOOD	(30)
#define AS_SND_20_BAD	(31)
#define AS_SND_21_POOR	(32)
#define AS_SND_22_EXCELLENT	(33)
#define AS_SND_23_FULL_COMBO	(34)
#define AS_SND_24_CLEARED	(35)
#define AS_SND_25_FAILED	(36)
#define AS_SND_26_YOU_WIN	(37)
#define AS_SND_27_YOU_LOSE	(38)
#define AS_SND_28_RESULT	(39)
#define AS_SND_29_YOUR_RANK_IS	(40)
#define AS_SND_30_S	(41)
#define AS_SND_31_A	(42)
#define AS_SND_32_B	(43)
#define AS_SND_33_C	(44)
#define AS_SND_34_D	(45)
#define AS_SND_35_E	(46)
#define AS_SND_36_F	(47)
#define AS_SND_37_THANK_YOU_FOR_PLAYING	(48)
...
extern const AGESoundRomMember ageSRM[49];
